        ...
        <div style={{ maxWidth: "860px", margin: "0 auto" }}>
          ...
          <div style={{ background: B.card, borderRadius: "14px", border: `1px solid ${B.border}`, overflow: "hidden", boxShadow: "0 2px 12px rgba(13,19,33,0.08)" }}>
            ...
            <div style={{ background: B.navy, padding: "18px 28px", textAlign: "center" }}>
              ...
              <button onClick={() => { }} stylimport { useState} from "react";
  ...
  const handleSubmit = async () => {
    ...
    if (Object.keys(e).length > 0) {setErrors(e); return; }
      ...
      `}</style>
              ...
              e={{ fontSize: "11px", color: B.light, textDecoration: "underline", background: "none", border: "none", cursor: "pointer", padding: 0 }}>Unsubscribe</button>
          </div>
          <div style={{ height: "4px", background: B.blue }} />
        </div>
      </div>

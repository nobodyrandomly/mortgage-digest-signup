...
Include EXACTLY 6 stories in the stories array — the 6 most important of the day. Mark 2-3 as high importance. Order: high importance first, then by recency. You may research and synthesize from more than 7 sources, but only the top 6 make the final stories array. The marketSnapshot narrative may reflect broader context drawn from all your research.
----------------------------------------------------------------

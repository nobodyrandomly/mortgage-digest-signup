// === GENERATOR CURSOR ===  FILE: generate-get-next-variant.js   NODE LABEL: 'Next Variant Digest'
// GET NEXT VARIANT TO GENERATE — picks next variant to RUN THROUGH GEMINI.
// PASTE THIS into the GENERATOR workflow's cursor node. Reads GenQueue.
